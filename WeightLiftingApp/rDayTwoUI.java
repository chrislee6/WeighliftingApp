...
public class rDayTwoUI extends BaseUI
{
    ...
    public rDayTwoUI(Person person, int week)
    {
        super(person);
        this.week=week;
    }
    ...
    public void display()
    {
        ...
        titleDay = new JLabel("Day 2 Running Workout", SwingConstants.CENTER);
        titleWeek = new JLabel("Week "+ week +" Workout", SwingConstants.CENTER);
        runWorkout = new JLabel("14 x 80 yds", SwingConstants.CENTER);
        time = new JLabel("<html>12 seconds or better.<br>45 second rest</html>",
